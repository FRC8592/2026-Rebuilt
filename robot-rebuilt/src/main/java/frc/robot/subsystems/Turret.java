...
public class Turret extends SubsystemBase{
    ...
    private double AOld = 20;
    private double VOld = 4;
    ...
    public void updateMotionMagic(){
        ...
        if(acceleration != AOld || cruiseVelocity != VOld){
            System.out.println("We are updating the value");
    ...
    public void periodic(){
        ...
        Logger.recordOutput("Motor Position", tMotor.getRotations());
        //SmartDashboard.putNumber("R1", (int)(E1Filter * TURRET.TURRET_G1));
        //SmartDashboard.putNumber("R2", (int)(E1Filter * TURRET.TURRET_G2));
