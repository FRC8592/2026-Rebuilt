...
public class AutoCommand extends WrapperCommand{
     ...
     */
    private AutoCommand(Command... commands) {
     ...
     */
    private static final Optional<Trajectory> getChoreoTrajectory(String name){
        return getChoreoTrajectory(name, -1);
    }
    
    private static final Optional<Trajectory> getChoreoTrajectory(String name, int splitIndex){
