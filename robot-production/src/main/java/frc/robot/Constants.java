...
public final class Constants {
  ...
  public final class SWERVE {
    ...
    public static final double TRANSLATE_POWER_SLOW = 0.2;
...
//    public static final double PATH_FOLLOW_DRIVE_KP = 1.0;
  ...
  public static final class SCORING {
    ...
    public static final Pose2d BLUE_PASSING_LOW_POSE = new Pose2d(MEASUREMENTS.FIELD_X_METERS * (1 / 4), 2.02, new Rotation2d(0));
    public static final Pose2d BLUE_PASSING_HIGH_POSE = new Pose2d(MEASUREMENTS.FIELD_X_METERS * (1 / 4), 6.05, new Rotation2d(0));

    public static final Pose2d RED_HUB_POSE = new Pose2d(11.94, 4.04, new Rotation2d(0));
    public static final Pose2d RED_PASSING_LOW_POSE = new Pose2d(MEASUREMENTS.FIELD_X_METERS * (3 / 4), 2.02, new Rotation2d(0));
    public static final Pose2d RED_PASSING_HIGH_POSE = new Pose2d(MEASUREMENTS.FIELD_X_METERS * (3 / 4), 6.05, new Rotation2d(0));
